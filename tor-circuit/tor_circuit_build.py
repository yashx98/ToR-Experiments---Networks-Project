...
def runForCountries(countries_list, num_hops):
  ...
  listCircuits()
  controller.reset_conf('__DisablePredictedCircuits', '1')
  controller.reset_conf('MaxOnionsPending', '0')
  controller.reset_conf('newcircuitperiod', '999999999')
  controller.reset_conf('maxcircuitdirtiness', '999999999')
...
def main():
  ...
  # runForCountries(countries_list)
  fig, ax = plt.subplots()
  x_axis = []
  for i in range(2, MAX_NUM_HOPS + 1):
    x_axis.append(i)
